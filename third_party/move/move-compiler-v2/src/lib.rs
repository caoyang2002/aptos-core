...
pub fn make_files_source_text(env: &GlobalEnv) -> FilesSourceText {
    info!("从全局环境中计算 FilesSourceText，该环境将IR位置文件哈希映射到文件和源代码...");
